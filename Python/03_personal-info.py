...
print("Gracias ",nom,"!!! me gusta tu primer apellido:",apellido1,", tu segundo apellido no esta nada mal: ", apellido2, "\nEl cuarto numero de tu telefono es mi preferido, ", telefono,"\nno conozco tu ciudad, ",ciudad, "\nyo soy muy joven, acabo de nacer, tu tienes exactamente:",edad,"años \nHA SIDO UN PLACER OBTENER TUS DATOS ^^ ")
