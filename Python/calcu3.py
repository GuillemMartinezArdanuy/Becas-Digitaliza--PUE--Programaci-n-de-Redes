...
#definimos variables booleanas, a modo de control
    ...
    diccionarioTotal = {1: {"Suma": Suma(primero, segundo)},
                        2: {"Resta": Resta(primero, segundo)},
                        3: {"Multiplicacion": Multiplicacion(primero, segundo)},
                        4: {"Division": Division(primero, segundo)},
                        5: {"Exponencial": Exponencial(primero, segundo)}}
    ...
    try:
        resultadoMostrar = (diccionarioTotal[opcionUsuario][nombreSeleccionadoOperacion]) # entramos al valor de la funcion que corresponde a lo seleccionado por el usuario
